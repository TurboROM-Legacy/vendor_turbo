...
ifndef TURBO_POSTFIX
    TURBO_POSTFIX := -$(shell date +"%Y%m%d-%H%M")
endif

PLATFORM_VERSION_CODENAME := $(TURBO_BUILD_TYPE)

# Set all versions
TURBO_VERSION := TURBO-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(TURBO_BUILD_TYPE)$(TURBO_POSTFIX)
TURBO_MOD_VERSION := TURBO-$(TURBO_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(TURBO_BUILD_TYPE)$(TURBO_POSTFIX)
