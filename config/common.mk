...
# Set all versions
TURBO_VERSION := Turbo-$(PRODUCT_VERSION_MINOR)-$(TURBO_BUILD_TYPE)$(TURBO_POSTFIX)
TURBO_MOD_VERSION := Turbo-$(TURBO_BUILD)-$(PRODUCT_VERSION_MINOR)-$(TURBO_BUILD_TYPE)$(TURBO_POSTFIX)
